    ...
    pub fn new() -> Self {
        ...
        knowledge_base.insert(
            ...
            vec![
                "2 + 2 = 4".to_string(),
                "π ≈ 3.14159".to_string(),
                "Pythagorean theorem: a² + b² = c²".to_string(),
            ]
        );
        ...
        knowledge_base.insert(
            "physics".to_string(),
            vec![
                "Speed of light: 299,792,458 m/s".to_string(),
                "F = ma (Newton's second law)".to_string(),
            ]
        );
    ...
    pub fn process_with_controls(
        ...
        if !should_answer {
            return ControlledOutput {
                answer: self.self_knowledge
                    .explain_limitation(task_type)
                    .unwrap_or_else(|| 
                        "I don't have enough confidence to answer that question accurately.".to_string()
                    ),
